...
;multiplication.
;
; All the definition's code is using the scoping capabilities of JCASM, so you
; can use the definition several times.
...
mul_add_scope!:
    and dummy_reg!, operand_b_reg!, #1          ; LSB of r1 is 1?
...
mul_skip_add_scope!:
    ...
    rshift operand_b_reg!, operand_b_reg!, #1   ; r1 = r1 >> 1 (to get next LSB)
    jnz mul_add_scope!                          ; loop until done
}

main:
    ; we want to perform 32 rounds of multiplication
    ldi r7, #32
